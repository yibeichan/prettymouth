...
#SBATCH --output=../logs/get_coflt_per_subject-%j.out
#SBATCH --error=../logs/get_coflt_per_subject-%j.err
#SBATCH --array=0-19 # 2 groups * 6 parcels
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python 03_get_coflt_PW.py $group_id $n_parcel