#!/bin/bash
#SBATCH --job-name=get_eFC_type_per_event
#SBATCH --output=../logs/get_eFC_type_per_event_%j.out
#SBATCH --error=../logs/get_eFC_type_per_event_%j.err
#SBATCH --array=0-3
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python 05_get_eFC_type_per_event.py $n_parcel $eFC_type $group
