...
def main(n_parcel: int, output_dir: str, behav_dir: str, parcellation_dir: str) -> None:
    ...
    boundary_file = os.path.join(behav_dir, "prominent_peaks_010.txt")
    ...
    observed, null_distribution, p_values = permutation_test(affair_seg, paranoia_seg, n_permutations=10000, n_jobs=12)
    ...
    output_file = os.path.join(distance_output_dir, f"event_group_distance_perm_ntw_peaks010.npz")
