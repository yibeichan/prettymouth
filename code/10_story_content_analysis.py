...
def main():
    ...
    # Create TR-level annotations (assuming 475 TRs as mentioned in the project guide)
    n_brain_trs = 475  # From the project guide information
    ...
    tr_annotations_df.to_csv(os.path.join(data_dir, '10_story_tr_annotations.csv'), index=False)
